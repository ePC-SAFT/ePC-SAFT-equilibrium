...
- Provider is an installed non-editable `epcsaft==0.2.0.dev0` distribution and remains sole EOS/derivative/domain owner; never copy Provider equations into this repo.
